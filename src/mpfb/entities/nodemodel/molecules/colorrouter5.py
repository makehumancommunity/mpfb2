...
class MpfbColorRouter5(Molecule):
    ...
    def create_group(self):
        ...
        self.add_input_socket("Section5Color", socket_type="NodeSocketColor", default_value=[0.0, 1.0, 1.0, 1.0])
        ...
        nodes["Math.003"] = self.createShaderNodeMath(name="Math.003", x=329.2713928222656, y=-568.2515258789062, Value=0.5, Value_001=0.5, Value_002=0.5, operation='GREATER_THAN', use_clamp=False)
        nodes["Mix.003"] = self.createShaderNodeMixRGB(name="Mix.003", x=570.2239379882812, y=-399.3313293457031, Fac=0.5, Color1=[0.5, 0.5, 0.5, 1.0], Color2=[0.5, 0.5, 0.5, 1.0], blend_type='MIX', use_alpha=False, use_clamp=False)
