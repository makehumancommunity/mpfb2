...
_LOG = LogService.get_logger("nodemodel.colorramp4")
_GROUP_NAME = "MpfbColorRamp4"

class MpfbColorRamp4(Molecule):
    def __init__(self):
    ...
    def create_group(self):
        ...
        nodes["Group Output"].location = [820.260498046875, -59.42645263671875]
        ...
        self.add_input_socket("BetweenStep3Color", socket_type="NodeSocketColor", default_value=[0.0, 1.0, 1.0, 1.0])
        self.add_input_socket("OneStopColor", socket_type="NodeSocketColor", default_value=[0.0, 0.0, 1.0, 1.0])
        self.add_input_socket("BetweenStep1Pos", socket_type="NodeSocketFloat", default_value=0.250)
        self.add_input_socket("BetweenStep2Pos", socket_type="NodeSocketFloat", default_value=0.500)
        self.add_input_socket("BetweenStep3Pos", socket_type="NodeSocketFloat", default_value=0.750)
        ...
        nodes["Map Range.002"] = self.createShaderNodeMapRange(name="Map Range.002", x=-498.586, y=-252.746, Value=1.000, From_Min=0.000, From_Max=1.000, To_Min=0.000, To_Max=1.000, Steps=4.000, Vector=[0.0, 0.0, 0.0], From_Min_FLOAT3=[0.0, 0.0, 0.0], From_Max_FLOAT3=[1.0, 1.0, 1.0], To_Min_FLOAT3=[0.0, 0.0, 0.0], To_Max_FLOAT3=[1.0, 1.0, 1.0], Steps_FLOAT3=[4.0, 4.0, 4.0], clamp=True, data_type='FLOAT', interpolation_type='LINEAR')
        nodes["Map Range.003"] = self.createShaderNodeMapRange(name="Map Range.003", x=-503.247, y=-534.338, Value=1.000, From_Min=0.000, From_Max=1.000, To_Min=0.000, To_Max=1.000, Steps=4.000, Vector=[0.0, 0.0, 0.0], From_Min_FLOAT3=[0.0, 0.0, 0.0], From_Max_FLOAT3=[1.0, 1.0, 1.0], To_Min_FLOAT3=[0.0, 0.0, 0.0], To_Max_FLOAT3=[1.0, 1.0, 1.0], Steps_FLOAT3=[4.0, 4.0, 4.0], clamp=True, data_type='FLOAT', interpolation_type='LINEAR')
        ...
        nodes["Mix.003"] = self.createShaderNodeMixRGB(name="Mix.003", x=525.311, y=-305.985, Fac=0.5, Color1=[1.0, 1.0, 1.0, 1.0], Color2=[0.0, 0.0, 0.0, 1.0], blend_type='MIX', use_alpha=False, use_clamp=False)
        ...
        self.add_link(nodes["Group Input"], "BetweenStep3Pos", nodes["Map Range.002"], "From Max")
        self.add_link(nodes["Group Input"], "BetweenStep3Pos", nodes["Map Range.003"], "From Min")
        self.add_link(nodes["Mix.002"], "Color", nodes["Mix.003"], "Color1")
        self.add_link(nodes["Group Input"], "BetweenStep3Color", nodes["Mix.002"], "Color2")
        self.add_link(nodes["Group Input"], "OneStopColor", nodes["Mix.003"], "Color2")
        self.add_link(nodes["Map Range.003"], "Result", nodes["Mix.003"], "Fac")
