...
_LOG = LogService.get_logger("fingerik.defaultfingerik")
...
class DefaultFingerIk(FingerIk):

    def __init__(self, which_hand, settings):
        _LOG.debug("Constructing DefaultFingerIk object")
        FingerIk.__init__(self, which_hand, settings)
