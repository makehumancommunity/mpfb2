...
_LOG = LogService.get_logger("armik.defaultarmik")
...
class DefaultArmIk(ArmIk):

    def __init__(self, which_arm, settings):
        _LOG.debug("Constructing DefaultArmIk object")
        ArmIk.__init__(self, which_arm, settings)
